...
export default function Info() {
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-20 px-6 md:px-12 w-full max-w-[1800px] mx-auto font-sans">
      
      {/* 1. Main Container (Flex) - Wraps Left and Right content */}
      <div className="flex flex-col md:flex-row gap-12 lg:gap-32 h-full">
        ...
        <div className="w-full md:w-[65%] flex flex-col justify-start">
          ...
          <div className="flex flex-col gap-8">
            <p className="text-xl md:text-2xl lg:text-3xl leading-relaxed text-[#1a1a1a] font-bold text-justify">
        ...
        <div className="w-full md:w-[35%] flex flex-col justify-between items-end h-full">
          ...
          <div className="w-full mb-12 md:mb-0">
             {/* Fallback logic: If image fails, show placeholder box to prevent broken UI */}
             {!imgError ? (
               <img 
                 src="https://i.imgur.com/tcx4Cw3.jpeg" 
                 alt="Portrait" 
          ...
          {/* Bottom CTA Link */}
          <div className="w-full text-right mt-auto pt-8">
            <Link 
              to="/contact" 
              className="inline-flex items-center justify-end gap-2 text-xl md:text-2xl text-gray-400 hover:opacity-60 transition-opacity font-light"
            >
